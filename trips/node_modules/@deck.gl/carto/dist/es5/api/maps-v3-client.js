...
function getParameters(_ref4) {
  ...
  parameters.push((0, _mapsApiCommon.encodeParameter)('v', V3_MINOR_VERSION));
...
function _mapInstantiation() {
  _mapInstantiation = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee4(_ref5) {
    var type, source, connection, credentials, geoColumn, columns, clientId, headers, aggregationExp, aggregationResLevel, queryParameters, baseUrl, url, accessToken, errorContext, body;
...
function _fetchTilestats2() {
  _fetchTilestats2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(attribute, dataset, accessToken, credentials) {
    var connection, source, type, statsUrl, url, errorContext, stats, attributes, index;
        ...
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            if (type === _mapsApiCommon.MAP_TYPES.QUERY) {
              url += "".concat(attribute, "?").concat((0, _mapsApiCommon.encodeParameter)('q', source));
            } else {
        ...
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            _loop = function _loop() {
              ...
              if (!filteredAttributes.find(function (_ref12) {
                var attribute = _ref12.attribute,
            ...
            promises = filteredAttributes.map(function (_ref13) {
...
function _fetchMap() {
  _fetchMap = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee12(_ref11) {
    var cartoMapId, clientId, credentials, headers, autoRefresh, onNewData, defaultCredentials, localCreds, accessToken, url, errorContext, map, stopAutoRefresh, intervalId, geojsonLayers, geojsonDatasetIds;
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          ...
          case 13:
            ...
            geojsonLayers = map.keplerMapConfig.config.visState.layers.filter(function (_ref15) {
              var type = _ref15.type;
              return type === 'geojson' || type === 'point';
            });
            geojsonDatasetIds = geojsonLayers.map(function (_ref16) {
            ...
            map.datasets.forEach(function (dataset) {
              if (geojsonDatasetIds.includes(dataset.id)) {
                var _geojsonLayers$find = geojsonLayers.find(function (_ref17) {
